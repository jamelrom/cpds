...
//solo pueden editar sanciones el jefe y el administrador, en el primer caso directamente
//y en el segundo caso, cuando se modifica un alumno, profesor o curso.
...
Meteor.methods({
  sancionActualizar: function(param){
    ...
    Sanciones.update(param.busqueda,param.actualizacion,{multi:true});
